      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center gap-4 text-sm">
            <Link to="/patrimoine" className={`px-3 py-1.5 rounded-full border border-transparent hover:bg-muted transition-colors ${location.pathname === "/patrimoine" ? "bg-muted" : ""}`}>
        ...
        {mobileMenuOpen && <nav className="md:hidden flex flex-col gap-2 mt-4 pb-2">
            <Link to="/patrimoine" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 text-left rounded-lg hover:bg-muted transition-colors">
              Gestion de patrimoine
            </Link>
